        ...
        <View style={styles.container}>
          ...
          <DrawerItem
            ...
            labelStyle={
              ...
              icon={({size}) => <FontAwesome name="user" size={25} color="#32ff7e" />}
            ...
            labelStyle={
              ...
              icon={({size}) => <Ionicons name="md-pizza" size={25} color="#32ff7e" />}
            ...
            icon={ ({size}) => <Entypo name="drink" size={25} color="#32ff7e" />}
          ...
          <DrawerItem
            ...
            icon={ ({size}) => <Entypo name="log-out" size={25} color="#32ff7e" />}
